...
public class StickerDialog extends JDialog {
	...
	void jbInit() throws Exception {
		...
		if (Context.get("STICKER_COLOR") != null) {
			Color c = new Color(Integer.parseInt((Context.get("STICKER_COLOR").toString()))); //removed Depreciated feature
		...
		if (Context.get("TEXT_COLOR") != null) {
			Color d = new Color(Integer.parseInt(Context.get("TEXT_COLOR").toString())); //removed Depreciated feature
