...
public class AppFrame extends JFrame {
    ...
    //create JSONUtils object
    JSONTool modifyJSON = new JSONTool();
    ...
    //create a work pane with the updated constructor
    ...
    JMenuItem jMenuFileNewPrj;
    JMenuItem jMenuFileNewNote;
    JMenuItem jMenuFilePackPrj;
    JMenuItem jMenuFileUnpackPrj;
    JMenuItem jMenuFileExportPrj;
    JMenuItem jMenuFileImportPrj;
    JMenuItem jMenuFileImportNote;
    JMenuItem jMenuFileExportNote;
    JMenuItem jMenuFileMin;
    ...
    JMenuItem jMenuHelpGuide;
    JMenuItem jMenuHelpWeb;
    JMenuItem jMenuHelpBug;
    JMenuItem jMenuHelpAbout;

    //Construct the frame
    public AppFrame(String whoIsUsingApp, int view) {

        modifyJSON.setUser(whoIsUsingApp,view);
        //create a work pane with the updated constructor
        workPanel = new WorkPanel(modifyJSON);
        editor = workPanel.dailyItemsPanel.editorPanel.editor;

        jMenuFileNewPrj = new JMenuItem();
        jMenuFileNewNote = new JMenuItem(workPanel.dailyItemsPanel.editorPanel.newAction);
        jMenuFilePackPrj = new JMenuItem(prjPackAction);
        jMenuFileUnpackPrj = new JMenuItem(prjUnpackAction);
        ...
        jMenuFileExportNote = new JMenuItem(
        ...
        jMenuFormatH6 = new JMenuItem(editor.new BlockAction(editor.T_H6,
                ""));
        jMenuFormatPRE = new JMenuItem(editor.new BlockAction(
                editor.T_PRE, ""));
        jMenuFormatBLCQ = new JMenuItem(editor.new BlockAction(
                editor.T_BLOCKQ, ""));
        jjMenuFormatChStyle = new JMenu();
        jMenuFormatChNorm = new JMenuItem(editor.new InlineAction(
                editor.I_NORMAL, ""));
        jMenuFormatChEM = new JMenuItem(editor.new InlineAction(
                editor.I_EM, ""));
        jMenuFormatChSTRONG = new JMenuItem(editor.new InlineAction(
                editor.I_STRONG, ""));
        jMenuFormatChCODE = new JMenuItem(editor.new InlineAction(
                editor.I_CODE, ""));
        jMenuFormatChCite = new JMenuItem(editor.new InlineAction(
                editor.I_CITE, ""));
        jMenuFormatChSUP = new JMenuItem(editor.new InlineAction(
                editor.I_SUPERSCRIPT, ""));
        jMenuFormatChSUB = new JMenuItem(editor.new InlineAction(
                editor.I_SUBSCRIPT, ""));
        jMenuFormatChCustom = new JMenuItem(editor.new InlineAction(
                editor.I_CUSTOM, ""));
        ...
        jMenuHelpGuide = new JMenuItem();
        jMenuHelpWeb = new JMenuItem();
        jMenuHelpBug = new JMenuItem();
    ...
    private void jbInit() throws Exception {
        ...
        jMenuFileMin.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F10,
                InputEvent.ALT_DOWN_MASK)); //Changed from ALT_MASK
                //@TODO Check timing in regards to key combo
    ...
    public void doExit() {
        ...
        //write to JSON before closing program
        modifyJSON.writeToJSON();
        ...
        Context.put("FRAME_XPOS", Integer.valueOf(this.getLocation().x)); //@Todo try catch if necessary
        Context.put("FRAME_YPOS", Integer.valueOf(this.getLocation().y));
        exitNotify();
        System.exit(0);
    }

    public void doMinimize() throws RuntimeException{
    ...
    protected void processWindowEvent(WindowEvent e) {
        if (e.getID() == WindowEvent.WINDOW_CLOSING) {
            ...
            //Issue found: Minimize appears to do window.close
        ...
        dlg.setVisible(true);
            ...
            protected void ppExport_actionPerformed(ActionEvent e) {
                ...
                if (dlg.CANCELLED)
                        ...
                        Context.put("EXPORT_SPLIT_NOTES", dlg.splitChB.isSelected()); //removed Depreciated feature
                        Context.put("EXPORT_TITLES_AS_HEADERS", dlg.titlesAsHeadersChB.isSelected()); //removed Depreciated feature
