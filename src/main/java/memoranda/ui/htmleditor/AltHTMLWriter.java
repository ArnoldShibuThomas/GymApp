...
public class AltHTMLWriter extends AbstractWriter implements Serializable {
    /*
            ...
            if (key instanceof CSS.Attribute) {
                if ((key == CSS.Attribute.FONT_FAMILY)
                    ...
                    if (weightValue != null) {
                        int fweight;
                        try {
                            Integer temp = Integer.valueOf(weightValue);
                            fweight = temp;
                        }
                        catch (Exception ex) {
                            fweight = -1;
     ...
     */
    static class PolygonRegionContainment extends Polygon implements RegionContainment, Serializable {
