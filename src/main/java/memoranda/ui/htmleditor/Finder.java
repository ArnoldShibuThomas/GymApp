    ...
    public void findAll() {
        ...
        while (matcher.find(start)) {
            ...
            if (_replace != null) {
                ...
                //@TODO Figure out if threading is necessary because Swing is not thread safe
                //If threading is necessary figure out a better way to implement a wait with mutex lock to avoid deadlock
