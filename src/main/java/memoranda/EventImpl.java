...
public class EventImpl implements Event, Comparable {
     ...
     */
    public int getHour() {
        return  parseInt(_elem.getAttribute("hour").getValue()); //Changed to valueOf from new Integer instance
    }
    ...
    public int getMinute() {
        return parseInt(_elem.getAttribute("min").getValue());
    }
    ...
    public int getPeriod() {
        ...
        if (a != null) return parseInt(a.getValue());
        return 0;
    }
    /**
